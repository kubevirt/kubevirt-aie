...
func parseConfigHybrid(_ string) (iommufdEnabled, atsSupported, atsEnabled, pasidSupported bool, ssidSize int, err error) {
...
// getOASFromCPU is a stub for non-ARM64 architectures.
// On ARM64, this reads the ID_AA64MMFR0_EL1 CPU register to determine the
// Output Address Size (OAS) supported by the processor (32-64 bits).
//
// Returns 0 since this is an ARM64-specific CPU feature.
